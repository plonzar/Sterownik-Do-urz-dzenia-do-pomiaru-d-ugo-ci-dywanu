...
const int ABORT_PIN = 11;
const int OPERATIONAL_BUTTON_PIN = 12;
...
const int ABORT_PIN_ACTIVE = LOW;
const int ABORT_PIN_INACTIVE = HIGH;

const int OPERATIONAL_BUTTON_PIN_ACTIVE = LOW;
const int OPERATIONAL_BUTTON_PIN_INACTIVE = HIGH;
...
const int ENGINE_REVERS_PIN_ACTIVE = LOW;
const int ENGINE_REVERS_PIN_INACTIVE = HIGH;
